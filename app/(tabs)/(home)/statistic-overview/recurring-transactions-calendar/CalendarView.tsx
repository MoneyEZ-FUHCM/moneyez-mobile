...
import TEXT_TRANSLATE_STATISTICAL from "./RecurringTransactionsCalendar.translate";
    ...
    <>
      <Calendar
        ...
        dayComponent={({
          ...
          const hasDot = state.dateCalendarResponseData?.items?.includes(
            date.day,
          );
          return (
            <TouchableOpacity
            ...
            >
              ...
              {hasDot && <Text style={styles.dot}>•</Text>}
