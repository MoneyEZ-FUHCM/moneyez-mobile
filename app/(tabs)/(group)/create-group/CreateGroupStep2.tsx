    ...
    <SafeAreaViewCustom>
      ...
      <View className="flex-1 bg-white">
          ...
          <View className="mb-6 flex-row items-center justify-between">
            <View className="flex-col items-center">
              <Svg width="45" height="45" viewBox="0 0 45 45" fill="black">
                ...
                <Path
                  d="M31.1651 15.847L22.5001 10.845L13.8381 15.847L22.5001 20.846L31.1651 15.847ZM23.5001 13.93V17.93H21.5001V13.93H23.5001ZM32.1601 17.582L23.5001 22.578V32.578L32.1601 27.578V17.582ZM26.5261 23.169L29.9901 25.169L28.9901 26.901L25.5261 24.901L26.5261 23.169ZM21.5001 32.577V22.577L12.8401 17.58V27.577L21.5001 32.577ZM19.4751 24.9L16.0111 26.9L15.0111 25.168L18.4751 23.168L19.4751 24.9Z"
                  fill="white"
                />
              </Svg>
              <Text className="mt-1 text-xs font-semibold text-black">
                {STEPS.STEP_1}
              </Text>
            ...
            <View className="mx-2 mb-9 h-[3px] flex-1 bg-[#E7E7E7]" />
            <View className="flex-col items-center">
              <Svg width="45" height="45" viewBox="0 0 45 45" fill="none">
                <Rect width="45" height="45" rx="22.5" fill="#E7E7E7" />
                <Path
                  d="M22.8333 12C28.3563 12 32.8333 16.477 32.8333 22C32.8333 27.523 28.3563 32 22.8333 32C17.3103 32 12.8333 27.523 12.8333 22C12.8333 16.477 17.3103 12 22.8333 12ZM22.8333 16C22.568 16 22.3137 16.1054 22.1261 16.2929C21.9386 16.4804 21.8333 16.7348 21.8333 17V22C21.8333 22.2652 21.9387 22.5195 22.1263 22.707L25.1263 25.707C25.3149 25.8892 25.5675 25.99 25.8297 25.9877C26.0918 25.9854 26.3427 25.8802 26.5281 25.6948C26.7135 25.5094 26.8186 25.2586 26.8209 24.9964C26.8232 24.7342 26.7224 24.4816 26.5403 24.293L23.8333 21.586V17C23.8333 16.7348 23.7279 16.4804 23.5404 16.2929C23.3528 16.1054 23.0985 16 22.8333 16Z"
                  fill="#757575"
                />
              </Svg>
              <Text className="mt-1 text-xs font-semibold text-[#757575]">
            ...
            <View className="flex-col items-center">
              <Svg width="45" height="45" viewBox="0 0 45 45" fill="none">
                ...
                >
                  <Path
                    d="M13.5 22C13.5 17.03 17.53 13 22.5 13C27.47 13 31.5 17.03 31.5 22C31.5 26.97 27.47 31 22.5 31C17.53 31 13.5 26.97 13.5 22Z"
                    fill="white"
                    stroke="white"
                    strokeWidth="2"
                    strokeLinecap="round"
        ...
        <View className="flex-1 justify-end pb-24">
          <TouchableOpacity className="w-full rounded-2xl px-4">
